...
def test_getGenomeMapping():
    ...
    assert getGenomeMapping(root_LRG_293, 'GRCh37') == ('chr13', 1, 1, '1'), "TEST DATA INCORRECT: Failed to obtain mapping information"
    assert getGenomeMapping(root_LRG_293, 'GRCh38') == ('chr13', 1, 1, '1'), "TEST DATA INCORRECT: Failed to obtain mapping information"
